    ...
    <div class="row justify-content-center">
        <div class="col-md-5">
            ...
            <div class="card login-card p-4 shadow">
                <h4 class="fw-bold text-center mb-2">Selamat Datang</h4>
                <p class="text-muted small text-center mb-4">Silakan masuk menggunakan akun Anda</p>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="nama@email.com">
                        </div>
                        @error('email')
                    ...
                    <button type="submit" class="btn btn-green w-100 py-2.5 fw-bold mb-3">MASUK</button>
                    
                    <div class="text-center mt-3">
                        <p class="small text-muted m-0">Belum punya akun? <a href="/register" class="text-green text-decoration-none fw-bold">Daftar Sekarang</a></p>
                    </div>
                </form>
            </div>
            
            <div class="text-center mt-3">
                <a href="{{ route('welcome') }}" class="text-muted small text-decoration-none"><i class="fa-solid fa-arrow-left me-1"></i> Kembali ke Beranda</a>
            </div>
        </div>
    </div>
</div>
